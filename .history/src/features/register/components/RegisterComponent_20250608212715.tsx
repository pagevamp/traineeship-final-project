...
const RegisterComponent = () => {
  ...
  // Scroll active step into view on step change
  useEffect(() => {
    const currentStepElement = stepRefs.current[currStep - 1];
    if (currentStepElement && stepperContainerRef.current) {
      // Scroll so that current step is centered horizontally in the container
...
// Keep your ChangeStep and RegisterStepX components as before...
