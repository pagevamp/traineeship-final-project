...
const RegisterStep2 = () => {
  return (
    <div className="text-[16px] w-full px-3 mt-[10px]">
      ...
      <div className="relative mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-[18px] gap-x-[10px]">
        {[...Array(2)].map((_, i) => (
          <React.Fragment key={i}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                className="py-2 px-4 placeholder:text-sm placeholder:text-[#9C9AA5] h-12"
                id={`director-phone-no-${i}`}
                name={`director-phone-no-${i}`}
