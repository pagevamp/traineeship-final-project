...
const RegisterComponent = () => {
  ...
  const [showRightArrow, setShowRightArrow] = useState(true); // Assume more steps exist initially

  // Scroll to center current step
  useEffect(() => {
    ...
    // Arrow visibility
    setShowLeftArrow(currStep > 1);
    setShowRightArrow(currStep < totalSteps);
  }, [currStep, totalSteps]);
  ...
  const renderStep = () => {
    switch (currStep) {
      ...
      case 4: return <RegisterStep4 />;
      case 5: return <RegisterStep5 />;
      case 6: return <RegisterStep6 />;
