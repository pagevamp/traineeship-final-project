...
const RegisterStep2 = () => {
  return (
    <div className="text-[16px] w-full px-3 mt-[10px]">
      <Button
        variant="outline"
        className="flex items-right mb-[26px] ml-[840px]"
      >
...
const RegisterStep6 = () => {
  return (
    <div className="text-[16px] w-full px-2 mt-[10px]">
      <Button
        variant="outline"
        className="flex items-right mb-[26px] ml-[840px]"
      >
      ...
      <div className="relative mb-8 grid grid-cols-4 gap-x-[38px] ">
        <div className="flex flex-col gap-2">
          <Label
            htmlFor="company-type"
            className="text-[16px] font-primary text-[#26203B]"
        ...
        <div className="flex flex-col gap-2">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectGroup>
                <SelectLabel>Select Shipment Type</SelectLabel>
