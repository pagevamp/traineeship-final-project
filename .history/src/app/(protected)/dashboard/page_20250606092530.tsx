    ...
    openModal({
      component: () => (
        <div className="relative">
          ...
          <button
            onClick={closeModal}
            className="absolute top-3 right-3 text-2xl font-bold bg-transparent border-none cursor-pointer hover:text-gray-600 transition"
            aria-label="Close modal"
          >
            &times;
          </button>

          {/* Your Department Form with closeModal prop */}
          <DepartmentForm closeModal={closeModal} />
        </div>
      ),
      className:
        "bg-white rounded-lg w-[668px] min-h-[369px] px-[66px] py-[18px] relative overflow-hidden",
